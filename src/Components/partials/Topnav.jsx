...
const TopNav = ({ left }) => {
  ...
  return (
    <div className="w-full h-[10vh] relative flex items-center justify-start pl-[15%]">
      <i className="ri-search-line text-zinc-400 text-xl cursor-pointer"></i>
      <input
        onChange={(e) => {
          setIsOpen(true);
        ...
        value={query}
        className="w-1/2 text-zinc-800 mx-5 px-5 pt-2 pb-3 outline-none text-xl border-none bg-white rounded-xl"
        type="text"
