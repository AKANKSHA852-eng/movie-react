  ...
  return (
    <div className="w-[20%] min-h-screen text-white border-r-2 border-zinc-200 p-10">
      ...
      <nav className="flex flex-col gap-5 text-zinc-400 text-2xl">
        <h1 className="text-white font-bold text-xl mt-10 nb-5">New Feeds</h1>
        <Link
          to="/trending"
          className="hover:bg-[#6556CD] hover:text-white font-semibold rounded-lg p-1 duration-300"
        >
      ...
      <nav className="flex flex-col gap-5 text-zinc-400 text-xl">
        <h1 className="text-white font-bold text-xl mt-10 nb-5">
          Website Information
        </h1>
        <Link className="hover:bg-[#6556CD] hover:text-white font-semibold rounded-lg p-1 duration-300">
