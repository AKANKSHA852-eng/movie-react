  ...
  return (
    <div className="w-[20%] h-full  border-r-2 border-zinc-400 p-10">
        ...
        <nav className='flex flex-col text-zinc-400 text-xl gap-2'>
            ...
            <Link className="hover:bg-[#6556CD] hover:text-white rounded-lg duration-300 p-1"> <i className="ri-information-fill"></i> About App</Link>
            <Link className="hover:bg-[#6556CD] hover:text-white rounded-lg duration-300 p-1"><i className="ri-phone-fill"></i>Contact</Link>
